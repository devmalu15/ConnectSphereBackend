...
using ConnectSphere.Comment.API.Repositories; 
using ConnectSphere.Comment.API.Services; 
using MassTransit; 
using ConnectSphere.Comment.API.Consumers;
...
{ 
    ...
    x.AddConsumer<CommentLikeToggledConsumer>();     
    x.AddConsumer<ComCommentAddedConsumer>();    
    x.AddConsumer<ComCommentDeletedConsumer>();  
